    ...
    <div class="container">
     ...
     <!-- img section -->
        <div class="col-md-6 col-xs-12">
            <img id="mainImage" class="img-thumbnail" src="images/image_slider/cairo_pyramid-of-khefren-and-the-sphinx1.jpg" height="500" width="100%">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-6">
                            <ul class="list icons list-unstyled">
                                <li><i class="fa fa-check"></i> 3 Nights Cairo  .</li>
                                <li><i class="fa fa-check"></i> 4 Breakfasts and 2 Lunches   .</li>
                                <li><i class="fa fa-check"></i> Meet at airport Upon arrival   .</li>
                            </ul>
                        </div>
                        <div class="col-md-6">	   
                                <ul class="list icons list-unstyled">
                                    <li><i class="fa fa-check"></i> Multi Lingua tour leader guide</li>	
                                    <li><i class="fa fa-check"></i> all Transfers by AC Minibus  .</li>
                                </ul>
                        </div>
