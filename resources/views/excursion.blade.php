        ...
        <div class="row">
            <div class="col-sm-5 order-2 order-sm-1 align-self-center p-static">
                <div class="overflow-hidden pb-2">
                    <h1 class="text-10 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="300">Egypt Excursions .</h1>
                </div>
                <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="400">
                    <span class="sub-title text-4 mt-4">Egypt is known from a long of years ago with its magnificent Nile 
                        and its fertile banks. we organize for Egypt lovers a trip on the wonderful Nile 
                        helping them to relieve all their sadness, feeling the spirit of pharaohs & the mystery of the Nile.</span>
                </div>
...
<div class="p-5 bg-white mt-0">
    <div class="container">
        ...
        <div id="sub_category" class="home_special_offer">
			...
			<a href="{{route('Nile-River-Cruises')}}">
				...
				<div class="home_special_offer_content">
					<a href="{{route('Nile-River-Cruises')}}">
						<div class="home_special_offer_title">
							<h2 class="mb-0 text-blue font-weight-bold">cairo</h2>
						</div>
					</a>
        ...
        <div id="sub_category" class="home_special_offer">
			...
			<a href="{{route('Nile-River-Cruises')}}">
				...
				<div class="home_special_offer_content">
					<a href="{{route('Nile-River-Cruises')}}">
						<div class="home_special_offer_title">
							<h2 class="mb-0 text-blue font-weight-bold">Aswan</h2>
						</div>
					</a>
						<div class="home_special_offer_description">
			...
			<a href="{{route('Nile-River-Cruises')}}">
				...
				<div class="home_special_offer_content">
					<a href="{{route('Budget_Tours')}}">
						<div class="home_special_offer_title">
							<h2 class="mb-0 text-blue font-weight-bold">Luxor</h2>
						</div>
					</a>
						<div class="home_special_offer_description">
							<p> Plan a luxury tour that will take you back to a bygone era of more comfortable travel.</p>
        ...
        <div id="sub_category" class="home_special_offer">
			...
			<a href="{{route('Nile-River-Cruises')}}">
				...
				<div class="home_special_offer_content">
					<a href="{{route('Budget_Tours')}}">
						<div class="home_special_offer_title">
							<h2 class="mb-0 text-blue font-weight-bold">Hurghada</h2>
						</div>
					</a>
						<div class="home_special_offer_description">
							<p> Plan a luxury tour that will take you back to a bygone era of more comfortable travel.</p>
        ...
        <div id="sub_category" class="home_special_offer">
			...
			<a href="{{route('Nile-River-Cruises')}}">
				...
				<div class="home_special_offer_content">
					<a href="{{route('Budget_Tours')}}">
						<div class="home_special_offer_title">
							<h2 class="mb-0 text-blue font-weight-bold">Sharm El Sheikh</h2>
						</div>
					</a>
						<div class="home_special_offer_description">
							<p> Plan a luxury tour that will take you back to a bygone era of more comfortable travel.</p>
