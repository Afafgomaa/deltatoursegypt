                ...
                <div class="home_exceptional_box">
                    ...
                    <div class="home_exceptional_content">
                        <div class="home_exceptional_box_title">
                            Inspiring tours                        </div>
                        <div class="home_exceptional_box_text">
                            We personalize your trip online before you go. Your guide tailors your experience on the spot to fit with your interests and questions.                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-xs-12">
                <div class="home_exceptional_box">
                    ...
                    <div class="home_exceptional_content">
                        <div class="home_exceptional_box_title">
                            Around-the-clock support                        </div>
                        <div class="home_exceptional_box_text">
                            Feel at ease traveling anywhere. Get your questions answered anytime via email, phone, or a knock on the door.                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-xs-12">
                <div class="home_exceptional_box">
                    ...
                    <div class="home_exceptional_content">
                        <div class="home_exceptional_box_title">
                            Comfort anywhere                        </div>
                        <div class="home_exceptional_box_text">
                            You'll be at home away from home in our prime accommodations. We only work with the best, most comfort-focused hotels.                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-xs-12">
                <div class="home_exceptional_box">
                    ...
                    <div class="home_exceptional_content">
                        ...
                        <div class="home_exceptional_box_text">
                            Use your debit card, credit card, or PayPal. Your transactions are protected by 3D Secure and SecureCode.                        </div>
                    </div>
                </div>
            </div>
        </div>
