							...
							<div class="scroll_tab_new" data-spy="scroll" data-target="#myNavbar" data-offset="120">
								<div id="overview" class="scroll_pane_new">
									<div class="program_box_data" id="desc">
										<p>
										4 Days Holiday tour package in Cairo staying in a 4 stars superior hotel and visiting the great
										 pyramids of giza , Egyptian museum, Old Cairo , Coptic museum as well felucca ride on the Nile
										</p>
									</div>
									<div class="program_box_title" id="include">
										Included:
									</div>
									<div class="program_box_data" id="include">
										<ul>
											<li>3 Nights 4 Stars superior Hotel on Bed and Breakfast</li>
											<li>3 Nights 4 Stars superior Hotel on Bed and Breakfast</li>
											<li>3 Nights 4 Stars superior Hotel on Bed and Breakfast</li>
										</ul>
										</div>
									<div class="program_box_title" id="exclude">Excluded:</div>
									<div class="program_box_data" id="exclude">
										<ul>
									...
									<table class="table table-striped push-top">
										<tbody>
											<tr><th>Per person In Double</th><td>250 USD </td></tr>
											<tr><th>Single Supplement over 2 Persons </th><td>50 USD</td></tr>
											<tr><th>Solo Traveler </th><td>300USD</td></tr>
											<tr><th>Child between 6 &amp; 12 Years </th><td>90USD</td></tr>
											<tr><th>Child between 0 and 6 Years  </th><td>Free</td></tr>
										</tbody>
									</table>
								</div>
										...
										<div class="program_box">
											<div class="program_box_title" id="reviews">Add On:</div>
												<div class="tab-pane active" id="addon">
													<div class="row">
													  <h3 class="program_box_title text-center"> Enhance your trip with these amazing added extras and bolt-ons</h3>
														<div class="col-md-12">
															...
															<span class="amount text-blue">From 35 USD </span>
